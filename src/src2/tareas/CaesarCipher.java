...
public class CaesarCipher {
	...
	public static void main(String[] args) {
		...
		for(int i=0 ; i < originalString.length() ; i++ ) {
			if((int)originalString.charAt(i)>=97 && (int)originalString.charAt(i)<=109) {
				System.out.print((char) (originalString.charAt(i)+13));
			}else if (originalString.charAt(i)>=110 && originalString.charAt(i)<=122) {
				System.out.print((char) (originalString.charAt(i)-13));
			}else if (originalString.charAt(i)>=65 && originalString.charAt(i)<=77) {
				System.out.print((char) (originalString.charAt(i)+13));
